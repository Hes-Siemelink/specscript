...
Mcp tool:
  create_ticket:
    ...
    script: create-ticket.spec.yaml
```
...
Mcp tool:
  create_ticket_batch:
    ...
    inputSchema:
      ...
      required:
        - batch
    script: create-ticket-batch.spec.yaml
```
...
Mcp tool:
  update_ticket:
    ...
    inputSchema:
      ...
      required: [ id ]
    script: update-ticket.spec.yaml
...
Mcp tool:
  delete_ticket:
    ...
    inputSchema:
      ...
      required: [ id ]
    script: delete-ticket.spec.yaml
```
